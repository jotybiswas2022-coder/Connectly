...
<head>
    ...
    <meta property="og:title" content="Create Account — Connectly">
...
@media (max-height: 600px) and (orientation: landscape) {
    ...
    .cr-bubble { display:none; }
    .cr-orb-1 { width:180px; height:180px; }
    .cr-orb-2 { width:150px; height:150px; }
    .cr-orb-3, .cr-orb-4 { display:none; }
    .cr-grid { display:none; }
}
@media (prefers-reduced-motion: reduce) {
    ...
    .cr-bubble, .cr-particles { display: none; }
    .cr-card { opacity: 1; transform: none; }
    .cr-brand-inner { opacity: 1; transform: none; }
}
