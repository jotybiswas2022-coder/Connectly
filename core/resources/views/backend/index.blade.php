...
<div class="db-page">
        ...
        <div class="db-header-content">
            ...
            <div class="db-header-right">
                <div class="db-header-stat">
                    <span class="db-header-stat-num">{{ $usersCount }}</span>
                    <span class="db-header-stat-label">Total Users</span>
                </div>
                <div class="db-header-stat">
                    <span class="db-header-stat-num">{{ $contactsCount }}</span>
                    <span class="db-header-stat-label">Messages</span>
                </div>
                <div class="db-header-stat">
                    <span class="db-header-stat-num">{{ $accountsCount }}</span>
                    <span class="db-header-stat-label">Admins</span>
                </div>
            </div>
        </div>
    ...
    <div class="db-stats">
        ...
        <div class="db-stat-card" style="--accent:#10b981;--accent-bg:rgba(16,185,129,0.1);">
        ...
        <div class="db-stat-card" style="--accent:#f59e0b;--accent-bg:rgba(245,158,11,0.1);">
            <div class="db-stat-icon"><i class="bi bi-people"></i></div>
            <div class="db-stat-info">
                <span class="db-stat-value">{{ $usersCount }}</span>
                <span class="db-stat-label">Total Users</span>
            </div>
            <div class="db-stat-trend up">
                <i class="bi bi-arrow-up-short"></i> Registered
            </div>
        </div>
    </div>
